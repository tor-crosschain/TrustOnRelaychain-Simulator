...
from locals.workload_ratio_analysis.aor import test_aor_async
from locals.workload_ratio_analysis.tor import test_tor_async

test_funcs = {"ToR": test_tor_async, "AoR": test_aor_async}
